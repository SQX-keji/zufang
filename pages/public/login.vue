<template>
	<view class="container">
		...
		<view class="register">
			...
			<view :style="isopen?'padding-top: 200rpx;':'padding-top: 200rpx;'" class=""
				style="margin-left: 36upx;color: #333333;font-size: 42upx;font-weight: 500;">
				<view style="">您好！ </view>
				<view style="margin-top: 20upx;">欢迎来到码兄租房</view>
				<view class="text-sm margin-top-xs" style="color: #999999;">未注册的手机号将自动创建账号</view>
			</view>
			<view style="margin:104upx 26upx 0;">

				<wInput :icon="iconphone" v-model="phoneData" type="number" maxlength="11" placeholder="请输入手机号"
					isShowCode ref="runCode" @setCode="sendMsg()"></wInput>
				<!-- <wInput v-model="passData" type="number" maxlength="6" placeholder="请输入密码"></wInput> -->
				<wInput :icon="iconmsg" v-model="verCode" type="number" maxlength="6" placeholder="请输入手机验证码" :isReturn="true" @toLogin="startReg"></wInput>
			...
			<view class="flex justify-between" style="margin: 0 26upx;">
				<view class="" style="color: #999999;font-size: 26rpx;" @click="bingwx()" v-if="isopen"> 微信快捷登录</view>
				<view class="" style="color: #999999;font-size: 26rpx;" @click="loginPhone()"> 账号密码登录</view>
				<view class="" style="color: #999999;font-size: 26rpx;" @click="gozhuce()" > 快速注册</view>
			</view>
		...
		<view class="mp_wxBox">
			<view>
				...
				<button v-show="weixinPhone" style="background: #4B74FF;color: #FFFFFF;" class="bottom"
